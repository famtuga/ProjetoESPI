    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TipoProvaID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Nome = table.Column<string>(maxLength: 80, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoProva", x => x.TipoProvaID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Horario_TipoProva_TipoProvaID",
                        column: x => x.TipoProvaID,
                        principalTable: "TipoProva",
                        principalColumn: "TipoProvaID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EstudanteDisciplina_Disciplina_EstudanteId",
                        column: x => x.EstudanteId,
                        principalTable: "Disciplina",
                        principalColumn: "DisciplinaId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EstudanteDisciplina_Estudante_EstudanteId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HorarioDisciplina_Horario_DisciplinaId",
                        column: x => x.DisciplinaId,
                        principalTable: "Horario",
                        principalColumn: "HorarioId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HorarioDisciplina_Disciplina_HorarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EstudanteDisciplina_EstudanteId1",
                table: "EstudanteDisciplina",
                column: "EstudanteId1");

            migrationBuilder.CreateIndex(
                name: "IX_Horario_TipoProvaID",
                table: "Horario",
                column: "TipoProvaID");
